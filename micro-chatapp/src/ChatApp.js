                  ...
                  <div>
                                      ...
                                      <div id="open-modal" className="modal-window">
                                          <div>
                                              <a href="#" title="Close" className="modal-close">
                                                ...
                                                <g>
                                                	<path className="mail-path" d="M26,0C11.664,0,0,11.663,0,26s11.664,26,26,26s26-11.663,26-26S40.336,0,26,0z M26,50C12.767,50,2,39.233,2,26
                                                		S12.767,2,26,2s24,10.767,24,24S39.233,50,26,50z"/>
                                                	<path className="mail-path" d="M35.707,16.293c-0.391-0.391-1.023-0.391-1.414,0L26,24.586l-8.293-8.293c-0.391-0.391-1.023-0.391-1.414,0
                      ...
                      <div >
                          <div className="modal-text">
                              ...
                              />
                              <GoogleLogin
                                  clientId="830450317717-2m954v3anhm9uv2meu787cg5i7ih0bs3.apps.googleusercontent.com"
                                  render={renderProps => (
                                      <button className="btn--primary--outline uppercase" onClick={renderProps.onClick} disabled={renderProps.disabled}>
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"x="0px" y="0px"
